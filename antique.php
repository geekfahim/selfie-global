         ...
         <div class="col-md-3">
             <div class="card " style="width: 18rem;">
              <img class="card-img-top light-box  light-box " src="image/pic1.jpg" alt="Card image cap">
                <h5 class="card-title text-center m-t-20">Dealer:&nbsp;&nbsp;Tahmid Ahmed </h5>
...
<div class="container-fluid">
      <div class="row">
         <div class="col-md-3">
             <div class="card " style="width: 18rem;">
              <img class="card-img-top light-box  light-box " src="image/pic1.jpg" alt="Card image cap">
                <h5 class="card-title text-center m-t-20">Photographer:&nbsp;&nbsp;Tahmid Ahmed </h5>
              <div class="card-body box">                  
                  <h6 class="selltitle">Price:&nbsp;&nbsp;2000Tk</h6>
                  <h6 class="selltitle">Location:&nbsp;&nbsp;Dhaka,Bangladesh</h6>
                  <div class="col-md-12 divider ">                                  
